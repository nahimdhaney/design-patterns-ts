// Run: tsc decorator/decorator.ts && node decorator/decorator.js
// Decorator Pattern - Structural Pattern
// Decorator pattern lets you dynamically change 
// the behavior of an object at run time by wrapping them in an object of a decorator class.
